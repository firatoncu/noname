...
from src.indicators import no_crossing_last_10, last500_macd_check
...
def check_buy_conditions(df, logger):
    try:
        ...
        return buyCondA and buyCondB and buyCondC and buyCondD and buyCondE
...
def check_sell_conditions(df, logger):
    try:
        ...
        sellCondE = slope_macd < 0
        sellCondF = last500_macd_check(macd_line, 500, logger)
